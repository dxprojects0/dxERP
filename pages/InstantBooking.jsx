...
const InstantBooking = () => {
    ...
    const bookings = useSelector((state) => state.business.serviceBookings);
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-slate-100">
            {bookings.map((b) => (<tr key={b.id}>
                ...
                <td className="p-3">
                  <select value={b.status} onChange={(e) => dispatch(updateServiceBookingStatus({ id: b.id, status: e.target.value }))} className="border rounded p-1 text-sm">
